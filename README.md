...
The first option is almost always sufficient. The `denial` library offers special primitives that cover the second and third options to cover the remaining uncertainty cases in Python:
...
This library defines an object that is used much like built-in `None`. This is how it is imported:
